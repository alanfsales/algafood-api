...
values (1, 'f46bf714-c0e9-11ec-aa2b-54bf64f4597a', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, sub_total, taxa_frete, valor_total)
values (2, '130f47a1-c0ea-11ec-aa2b-54bf64f4597a' ,4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
