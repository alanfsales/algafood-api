...
import com.algaworks.algafood.api.v1.openapi.model.PegeableModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocketV1() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.POST, globalPostPutReposMessages())
				.globalResponseMessage(RequestMethod.PUT, globalPostPutReposMessages())
				.globalResponseMessage(RequestMethod.DELETE, globalDeleteReposMessages())
				...
				.tags(new Tag("Cidades", "Gerencia as cidades"), 
						...
						new Tag("Formas de pagamento", "Gerencia as forma de pagamento"),
...
//	@Bean
	...
	private List<ResponseMessage> globalGetReposMessages(){
	...
	private List<ResponseMessage> globalPostPutReposMessages(){
		return Arrays.asList(
				new ResponseMessageBuilder()
	...
	private List<ResponseMessage> globalDeleteReposMessages(){
		return Arrays.asList(
				new ResponseMessageBuilder()
					.code(HttpStatus.BAD_REQUEST.value())
					.message("Requisição inválida (erro do cliente)")
	...
	private ApiInfo apiInfoV1() {
		return new ApiInfoBuilder()
				...
				.description("API aberta para clientes e restaurantes.<br>"
						+ "<strong>Essa versão da API está depreciada e deixará de existir a parter de 01/01/2023. "
