...
public class RestauranteController implements RestauranteControllerOpenApi {
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void ativarMultiplos(@RequestBody List<Long> restuaranteIds) {
		try {
			cadastroRestaurante.ativar(restuaranteIds);
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void inativarMultiplos(@RequestBody List<Long> restuaranteIds) {
		try {
			cadastroRestaurante.inativar(restuaranteIds);
		} catch (RestauranteNaoEncontradoException e) {
			throw new NegocioException(e.getMessage(), e);
		}
	}
